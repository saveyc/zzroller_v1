...
void System_Setup(void)
{
    ...
    /* Enable USART1 clock */
    RCC_APB1PeriphClockCmd(RCC_APB1Periph_PWR | RCC_APB1Periph_BKP | RCC_APB1Periph_CAN1, ENABLE);
...
void GPIO_Configuration(void)
{
    ...
    //input
    //IN1_0,IN1_1,IN1_2,IN1_3,IN1_4,IN1_5
    ...
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(GPIOB, &GPIO_InitStructure);
    //OUT1_1,OUT1_2,OUT1_3,OUT1_4,OUT1_5,OUT1_6,OUT1_7
    ...
    //DIP2-DIP6
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12 | GPIO_Pin_7 | GPIO_Pin_6 | GPIO_Pin_5 | GPIO_Pin_4;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(GPIOA, &GPIO_InitStructure);
    //DIP1
